...
function initializeOverlay(textarea: HTMLTextAreaElement) {
  ...
  self.addEventListener("scroll", scrollHandler, true);
...
async function initialize() {
  ...
  if (mod) {
    ...
    console.error(
      "Failed to load WASM module. This is likely caused by the current site not allowing WASM to be loaded. In a future version, WASM will be loaded in the background script to circumvent this issue.",
    );
  }
