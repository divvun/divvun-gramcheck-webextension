...
export const getBaseBuildConfig = (isProduction = false): BuildOptions => ({
  plugins: [...denoPlugins()],
  entryPoints: {
...
export const buildWasm = async (): Promise<boolean> => {
...
export const copyPolyfill = async () => {
...
export const copyWasmFiles = async (src: string, dest: string) => {
...
export const processHTML = async (templatePath: string, outputPath: string, scriptName: string) => {
